        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">BookMyCourt.lk</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              The premier platform for booking sports courts across Sri Lanka. 
              Find, book, and enjoy your favorite sports facilities with ease.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">+94 77 421 8840</span>
              </li>
              <li className="flex items-center space-x-2">
                <EnvelopeIcon className="w-4 h-4 text-gray-400" />
                <span className="text-gray-300">info@bookmycourt.lk</span>
              </li>
              <li className="flex items-center space-x-2">
                <GlobeAltIcon className="w-4 h-4 text-gray-400" />
                <span className="text-gray-300">www.bookmycourt.lk</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 BookMyCourt.lk. All rights reserved.
            </p>
